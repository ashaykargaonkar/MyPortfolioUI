        ...
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          >
            <motion.p
              ...
              className="text-base md:text-lg lg:text-xl text-gray-300"
            >
              My work includes <a href="https://thinkmovesui.vercel.app" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-500 underline hover:no-underline transition-colors duration-200">ThinkMoves</a> — an AI-driven platform that converts handwritten chess scoresheets into digital PGNs using <span className={textBlue}>OCR</span>, <span className={textBlue}>computer vision</span>, and cloud automation — and <span className={textBlue}>AshayTalks</span>, a <span className={textBlue}>AI chatbot</span> built to make my career story instantly accessible.
